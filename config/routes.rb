Rails.application.routes.draw do
  namespace :api do
    namespace :v1 do
      ...
      get 'system_statistics/highest_rides_users_by_month/:month/:year', to: 'system_statistics#highest_rides_users_by_month'
      get 'system_statistics/highest_rides_drivers_by_month/:month/:year',  to: 'system_statistics#highest_rides_drivers_by_month'
      get 'system_statistics/calculate_usage_percentage'
